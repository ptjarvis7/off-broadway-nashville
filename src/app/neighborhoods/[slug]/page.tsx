...
const neighborhoodIntros: Record<string, string> = {
  ...
  'The Gulch': "The Gulch punches above its weight musically. The Station Inn is a genuine world-class bluegrass venue, Rudy's Jazz Room is the real deal, and Third Man Records' Blue Room is unlike anything else in Nashville.",
  ...
  'SoBro': "South of Broadway but not part of it. The Listening Room Cafe is one of the best songwriter venues in the country. Ascend Amphitheater has the best skyline views of any outdoor venue in the city.",
